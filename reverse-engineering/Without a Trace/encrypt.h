...
#define SECRET_FUNC __attribute__((section(".secret")))
#define SECRET_HELPER_FUNC __attribute__((section(".secrethelper")))

#define FORBIDDEN_FUNC __attribute__((section(".forbidden")))
